...
function SignInPage() {
  ...
  return (
    <main className="min-h-screen flex">
      {/* Bloc gauche - Formulaire de connexion */}
      <div className="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div className="w-full max-w-md space-y-8">
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-anthracite/60 hover:text-anthracite transition-colors"
                  tabIndex={-1}
                >
                  {showPassword ? (
          ...
          {/* Affichage des boutons OAuth seulement s'il y en a */}
          {providers &&
              ...
              <div className="mt-8">
                <div className="relative">
                  <div className="absolute inset-0 flex items-center">
                    <div className="w-full border-t border-sable"></div>
                  </div>
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white text-anthracite/60">Ou</span>
                  </div>
                </div>
          ...
          <div className="text-center text-sm text-anthracite/70">
            <p>
              Pas encore de compte?{" "}
              <Link href="/inscription" className="text-sauge hover:underline font-medium">
                S&apos;inscrire
              </Link>
            </p>
          </div>
